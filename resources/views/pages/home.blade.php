<x-layouts.app title="CV. Aksa Karya Fibertek" meta-description="CV. Aksa Karya Fibertek Produsen tangki air, septic tank, dan produk fiberglass custom bergaransi, tersertifikasi, siap kirim ke seluruh Indonesia.">
    ...
    <section class="relative h-screen min-h-[600px] max-h-[800px] overflow-hidden bg-slate-900">
        ...
        <div id="hero-slides" class="relative w-full h-full">
            ...
            <div class="hero-slide absolute inset-0 transition-opacity duration-700" data-slide="0">
                ...
                <div class="relative z-10 h-full flex items-center">
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                        <div class="max-w-2xl">
                            <div class="inline-flex items-center gap-2 bg-blue-500/20 border border-blue-400/40 text-blue-300 text-sm font-medium px-4 py-1.5 rounded-full mb-6">
                                <span class="w-2 h-2 bg-blue-400 rounded-full animate-pulse"></span>
                                Produsen Fiberglass Tersertifikasi
                            </div>
                            <h1 class="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
                                Solusi Tangki &amp;<br>
                                Sanitasi Fiber <span class="text-blue-400">Presisi Tinggi.</span>
                            </h1>
                            ...
                            <div class="flex flex-col sm:flex-row gap-4">
                                <a href="https://wa.me/6282345651976?text=Halo%20CV.%20Aksa%20Karya%20Fibertek%2C%20saya%20ingin%20konsultasi%20gratis" target="_blank"
                                   class="inline-flex items-center justify-center gap-2 bg-blue-500 hover:bg-blue-400 text-white font-semibold px-7 py-3.5 rounded-xl transition-all duration-200 hover:shadow-lg hover:shadow-blue-500/30 hover:-translate-y-0.5">
                    ...
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                        <div class="max-w-2xl">
                            ...
                            <h2 class="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
                                Material Terbaik,<br>
                                <span class="text-blue-400">Garansi 10 Tahun.</span>
                            </h2>
                            <p class="text-slate-300 text-lg leading-relaxed mb-8 max-w-xl">
            ...
            <div class="hero-slide absolute inset-0 transition-opacity duration-700 opacity-0" data-slide="2">
                <img src="{{ asset('images/1.webp') }}"
                     alt="Tim Ahli CV. Aksa Karya Fibertek"
                     class="absolute inset-0 w-full h-full object-cover grayscale-[30%]">
                <div class="hero-overlay absolute inset-0"></div>
                <div class="relative z-10 h-full flex items-center">
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                        <div class="max-w-2xl">
                            ...
                            <h2 class="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight mb-6">
                                ...
                                <span class="text-blue-400">Instalasi Selesai.</span>
                            </h2>
                            <p class="text-slate-300 text-lg leading-relaxed mb-8 max-w-xl">
        ...
        <div class="absolute bottom-6 left-1/2 -translate-x-1/2 z-20 flex items-center gap-2">
            @for($i = 0; $i < 3; $i++)
                <button class="slider-dot h-2 rounded-full transition-all duration-300 {{ $i === 0 ? 'active bg-blue-400 w-6' : 'bg-white/50 w-2 hover:bg-white/80' }}"
                        data-dot="{{ $i }}"></button>
            @endfor
        </div>
    </section>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div class="relative">
                    <div class="relative rounded-2xl overflow-hidden shadow-2xl aspect-[4/3]">
                        <img src="{{ asset('images/3.webp') }}"
                             alt="Pembangunan Proyek CV. Aksa Karya Fibertek"
                             class="w-full h-full object-cover">
                        <div class="absolute inset-0 bg-gradient-to-t from-slate-900/60 to-transparent"></div>
                        <div class="absolute bottom-4 left-4">
                            <span class="inline-flex items-center gap-1.5 bg-blue-500 text-white text-xs font-semibold px-3 py-1.5 rounded-full">
                ...
                <div>
                    <h2 class="text-3xl sm:text-4xl font-bold text-slate-900 mb-3">
                        Jejak Langkah &amp; <span class="text-blue-600">Pencapaian</span>
                    </h2>
                    ...
                    <div class="flex gap-1 bg-white rounded-xl p-1 border border-slate-200 mb-6 w-fit">
                        @foreach(['Angka Kunci', 'Sebaran Proyek', 'Grafik Pertumbuhan'] as $i => $tab)
                            <button class="stats-tab px-4 py-2 text-sm font-medium rounded-lg transition-all duration-200 {{ $i === 0 ? 'bg-white text-blue-600 shadow-sm border border-slate-200' : 'text-slate-500 hover:text-slate-700' }}"
                                    data-tab="{{ $i }}">
                                {{ $tab }}
                            </button>
                        @endforeach
                    ...
                    <div id="stats-content-0" class="stats-content">
                        <div class="grid grid-cols-2 gap-4">
                            @foreach([
                                ...
                                <div class="bg-white rounded-xl p-5 border border-slate-200 hover:border-blue-300 hover:shadow-md transition-all duration-200 group">
                                    <div class="text-3xl font-bold text-slate-900 group-hover:text-blue-600 transition-colors duration-200">{{ $num }}</div>
                        ...
                        <div class="mt-5 bg-white rounded-xl p-4 border border-slate-200">
                            ...
                            @foreach([['Sistem IPAL', 45], ['Septic Tank', 30], ['Tangki Air', 15], ['Lainnya', 10]] as [$cat, $pct])
                            ...
                            <div class="grid grid-cols-3 gap-3">
                                @foreach(['Sumatera', 'Jawa', 'Kalimantan', 'Sulawesi', 'Bali & NT', 'Papua'] as $island)
                                    <div class="text-center p-3 bg-blue-50 rounded-lg border border-blue-100">
                                        <div class="text-xs text-blue-700 font-medium">{{ $island }}</div>
                                    </div>
                                @endforeach
                            </div>
                        </div>
                            ...
                            @foreach([[2020, 180], [2021, 220], [2022, 310], [2023, 420], [2024, 510], [2025, 640]] as [$year, $val])
                                <div class="flex items-center gap-3 mb-2">
                                    ...
                                    <div class="flex-1 h-3 bg-slate-100 rounded-full overflow-hidden">
                                        <div class="h-3 bg-gradient-to-r from-blue-500 to-blue-400 rounded-full transition-all duration-700" style="width: {{ round($val / 640 * 100) }}%"></div>
                                    </div>
    ...
    <section class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <div class="inline-block bg-blue-50 text-blue-700 text-xs font-semibold px-3 py-1 rounded-full uppercase tracking-wide mb-3">Produk Unggulan</div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                @foreach($products as $product)
                    <a href="{{ route('produk.detail', $product['slug']) }}"
                       class="group bg-white rounded-2xl border border-slate-200 overflow-hidden hover:border-blue-300 hover:shadow-xl transition-all duration-300 flex flex-col">
                        ...
                        <div class="p-6 flex flex-col flex-1">
                            ...
                            <div class="flex items-center gap-1.5 text-blue-600 text-sm font-semibold mt-4 group-hover:gap-3 transition-all duration-200">
                                Detail Produk
            ...
            <div class="text-center mt-10">
                <a href="{{ route('produk') }}"
                   class="inline-flex items-center gap-2 border-2 border-blue-500 text-blue-600 hover:bg-blue-500 hover:text-white font-semibold px-8 py-3 rounded-xl transition-all duration-200">
                    Lihat Semua Produk
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"/>
                    </svg>
    ...
    <section class="py-20 bg-slate-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                {{-- Left: Text --}}
                <div>
                    <div class="inline-block bg-blue-50 text-blue-700 text-xs font-semibold px-3 py-1 rounded-full uppercase tracking-wide mb-4">Keunggulan Kami</div>
                    <h2 class="text-3xl sm:text-4xl font-bold text-slate-900 mb-4">Kenapa Memilih CV. Aksa Karya Fibertek?</h2>
    ...
    <!-- <section class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="relative">
                <div id="partner-slider" class="overflow-hidden">
                    <div id="partner-track" class="flex gap-6 transition-transform duration-500">
                        @foreach($partners as $i => $partner)
                            <div class="partner-card shrink-0 w-64 bg-white rounded-2xl border border-slate-200 p-6 hover:border-blue-300 hover:shadow-lg transition-all duration-300 group">
                                ...
                                <h3 class="font-semibold text-slate-900 mb-2 group-hover:text-blue-600 transition-colors duration-200">{{ $partner['name'] }}</h3>
                                <p class="text-slate-500 text-xs leading-relaxed mb-4 line-clamp-3">{{ $partner['desc'] }}</p>
                                <a href="#" class="text-blue-600 text-xs font-semibold hover:underline">Lihat Detail â†’</a>
                            </div>
                        @endforeach
                    </div>
                </div>
                ...
                {{-- Arrows --}}
                <button id="partner-prev" class="absolute -left-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-white border border-slate-200 hover:border-blue-300 hover:bg-blue-50 rounded-full shadow-md flex items-center justify-center transition-all duration-200 z-10">
                    <svg class="w-4 h-4 text-slate-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/>
                    </svg>
                </button>
                <button id="partner-next" class="absolute -right-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-white border border-slate-200 hover:border-blue-300 hover:bg-blue-50 rounded-full shadow-md flex items-center justify-center transition-all duration-200 z-10">
                    <svg class="w-4 h-4 text-slate-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/>
                    </svg>
                </button>
                ...
                <div class="flex items-center justify-center gap-2 mt-6">
                    @for($i = 0; $i < 2; $i++)
                        <button class="partner-dot w-8 h-8 rounded-full border-2 flex items-center justify-center text-xs font-semibold transition-all duration-200 {{ $i === 0 ? 'bg-blue-500 border-blue-500 text-white' : 'border-slate-300 text-slate-500 hover:border-blue-300' }}"
    ...
    (function () {
        ...
        function goTo(n) {
            ...
            dots[current].classList.remove('active', 'bg-blue-400', 'w-6');
            ...
            dots[current].classList.add('active', 'bg-blue-400', 'w-6');
    ...
    // â”€â”€ Stats Tabs â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    (function () {
        ...
        tabs.forEach((tab) => {
            tab.addEventListener('click', () => {
                ...
                tabs.forEach(t => {
                    t.classList.remove('bg-white', 'text-blue-600', 'shadow-sm', 'border', 'border-slate-200');
                    t.classList.add('text-slate-500');
                });
                tab.classList.add('bg-white', 'text-blue-600', 'shadow-sm', 'border', 'border-slate-200');
    ...
    // â”€â”€ Partner Slider â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    (function () {
        ...
        function goTo(p) {
            ...
            dots.forEach((d, i) => {
                d.classList.toggle('bg-blue-500', i === page);
                d.classList.toggle('border-blue-500', i === page);
