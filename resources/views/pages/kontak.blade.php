<x-layouts.app title="Kontak — Aksara Karya" meta-description="Hubungi Aksara Karya untuk konsultasi, penawaran, atau pertanyaan seputar produk tangki fiberglass dan sistem sanitasi kami.">
    ...
    <section class="bg-slate-900 py-20 px-4 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto relative z-10 text-center">
            ...
            <p class="text-slate-400 text-base max-w-xl mx-auto">
                Tim teknis kami siap menjawab pertanyaan, memberikan konsultasi, dan menyiapkan penawaran terbaik untuk Anda.
            </p>
        </div>
    </section>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-5 gap-12">
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    @foreach([
                        [
                            ...
                            'title' => 'Alamat',
                            'lines' => ['Jl. Industri Raya No. 45', 'Kawasan Industri Modern', 'Tangerang, Banten 15122'],
                            'href' => null,
                        ],
                        [
                        ...
                        [
                            ...
                            'title' => 'Email',
                            'lines' => ['sales@aksarakarya.co.id'],
                            'href' => 'mailto:sales@aksarakarya.co.id',
                        ],
                    ] as $contact)
                        <div class="flex items-start gap-4 bg-white rounded-xl p-5 border border-slate-200 hover:border-cyan-300 transition-colors duration-200">
                            ...
                            <div>
                                ...
                                @foreach($contact['lines'] as $line)
                                    @if($contact['href'])
                                        <a href="{{ $contact['href'] }}" class="block text-slate-800 text-sm font-medium hover:text-cyan-600 transition-colors duration-150">{{ $line }}</a>
                                    @else
                    ...
                    <a href="https://wa.me/6281234567890?text=Halo%20Aksara%20Karya%2C%20saya%20ingin%20konsultasi" target="_blank"
                ...
                <div class="lg:col-span-3">
                    <div class="bg-white rounded-2xl border border-slate-200 p-8 shadow-sm">
                        ...
                        <p class="text-slate-500 text-sm mb-7">Isi formulir di bawah dan kami akan menghubungi Anda dalam 1x24 jam.</p>
                        ...
                        <form id="contact-form" class="space-y-5" onsubmit="handleSubmit(event)">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                ...
                                <div>
                                    ...
                                    <input type="tel" id="telepon" name="telepon" required placeholder="+62 812 xxxx xxxx"
                                           class="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition-all duration-200">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <select id="produk" name="produk"
                                    ...
                                    @foreach(['Tangki Air Fiber', 'Septic Tank Biotech', 'Tangki Air Panel', 'Sistem IPAL', 'Grease Trap', 'Lainnya'] as $opt)
    ...
    <section class="h-72 bg-slate-200 relative overflow-hidden">
        <img src="https://images.unsplash.com/photo-1524661135-423995f22d0b?w=1600&auto=format&fit=crop&q=80"
             alt="Lokasi Aksara Karya"
             class="w-full h-full object-cover opacity-60">
        <div class="absolute inset-0 flex items-center justify-center">
            <div class="bg-white rounded-2xl shadow-xl p-5 text-center max-w-sm mx-4">
                <div class="w-10 h-10 bg-cyan-500 rounded-xl flex items-center justify-center mx-auto mb-3">
                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>
                    </svg>
                </div>
                <div class="font-semibold text-slate-900 text-sm">Aksara Karya Utama</div>
                <div class="text-slate-500 text-xs mt-1">Jl. Industri Raya No. 45, Tangerang</div>
            </div>
        </div>
    </section>
